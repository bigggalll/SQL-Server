...
*********************************************************************************************/
/********************************************************************************************
Modifications apportées par Alain Martin

Retourne la colonne context_info formater en varchar(128)
*********************************************************************************************/
...
--~
	...
	@output_column_list VARCHAR(8000) = '[dd%][session_id][sql_text][sql_command][login_name][wait_info][tasks][tran_log%][cpu%][temp%][block%][reads%][writes%][context%][context_info][physical%][query_plan][locks][%]',
			...
			(
				...
				(
					SELECT TOP(@i)
						...
						COALESCE(r.context_info, s.context_info) AS context_info,
			...
			'( ' +
				'SELECT ' +
					...
					'CASE ' +
						...
						'ELSE request_id ' +
					'END AS request_id, ' +
					'GETDATE() AS collection_time, Cast(context_info  AS VARCHAR(128)) AS context_info  '

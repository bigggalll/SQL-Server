...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Qj##WhoIsActive', 
		...
		@notify_level_page=0, 
		@delete_level=0, 
		@description=N'Capturer l''information sur les sessions actives avec l''aide de la sp sp_WhoIsActive. Les informations sont conservés dans la table DBA_SQL01P.dbo.WhoIsActive.', 
		@category_name=N'Qj##', 
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'GradData', 
	...
	@delta_interval = 10,
	@show_sleeping_spids = 2,
	@destination_table = ''dba_log.dbo.WhoIsActive''', 

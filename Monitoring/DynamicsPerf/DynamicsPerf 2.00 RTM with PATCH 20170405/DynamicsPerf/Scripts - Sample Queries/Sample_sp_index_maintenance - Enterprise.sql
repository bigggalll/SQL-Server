...
*********************************************************************************************/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].SP_INDEX_MAINTENANCE_ENTERPRISE') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[SP_INDEX_MAINTENANCE_ENTERPRISE]
GO
...
o.name,
i.name,
max(f.avg_fragmentation_in_percent) as avg_fragmentation_in_percent

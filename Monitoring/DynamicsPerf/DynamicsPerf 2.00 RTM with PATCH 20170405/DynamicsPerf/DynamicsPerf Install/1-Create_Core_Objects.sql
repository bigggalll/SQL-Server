...
CREATE TABLE [dbo].[DATABASES_2_COLLECT] (
    ...
    [NUM_PLANS_TO_KEEP]           INT          NULL,
    [IGNORE_QUERIES_UNDER_MS]     INT          NULL,
    [COLLECT_TOP_X_QUERIES]       INT          NULL,
    [COLLECT_TOP_X_PLANS]         INT          NULL,
    [KEEP_TOP_X_QUERIES_BY_MONTH] INT          NULL,
    [KEEP_TOP_X_PLANS_BY_MONTH]   INT          NULL,
    [PURGE_PLANS_AFTER_X_DAYS]    INT          NULL
);
...
CREATE TABLE [dbo].[AX_SQLTRACE] (
    ...
    [CANPROCESS]                    AS             (CASE WHEN [QUERY_HASH] IS NULL
...
CREATE NONCLUSTERED INDEX [IX_AX_SQLTRACE_CANPROCESS]
    ON [dbo].[AX_SQLTRACE]([QUERY_HASH] ASC, [CANPROCESS] ASC, [DATABASE_NAME] ASC, [SERVER_NAME] ASC);
...
CREATE NONCLUSTERED INDEX [IX_QUERY_MI_FLAG_PLAN_HANDLE]
    ON [dbo].[QUERY_PLANS]([MI_FLAG] ASC, [QUERY_PLAN_HASH] ASC, [SERVER_NAME] ASC, [DATABASE_NAME] ASC, [DATE_UPDATED] ASC);
...
CREATE NONCLUSTERED INDEX [IX_QUERY_PLANS_DATE_UPDATED]
    ON [dbo].[QUERY_PLANS]([DATE_UPDATED] ASC, [SERVER_NAME] ASC, [DATABASE_NAME] ASC);
...
CREATE CLUSTERED INDEX [IX_SSRS_REPORT]
    ON [dbo].[SSRS_EXECUTIONLOG]([TIMEEND] ASC, [SERVER_NAME] ASC, [DATABASE_NAME] ASC, [INSTANCE_NAME] ASC);
...
CREATE NONCLUSTERED INDEX [IX_INDEX_HISTORY1]
    ON [dbo].[QUERY_HISTORY]([SERVER_NAME] ASC, [DATABASE_NAME] ASC, [QUERY_HASH] ASC, [DATE] ASC, [FLAG] ASC, [EXECUTION_COUNT_TODAY] ASC, [QUERY_PLAN_HASH] ASC);
...
CREATE NONCLUSTERED INDEX [IX_INDEX_HISTORY2]
    ON [dbo].[QUERY_HISTORY]([SERVER_NAME] ASC, [DATABASE_NAME] ASC, [QUERY_HASH] ASC, [QUERY_PLAN_HASH] ASC, [DATE] ASC, [FLAG] ASC, [EXECUTION_COUNT_TODAY] ASC);
...
CREATE CLUSTERED INDEX [IX_SSRS_HIST]
    ON [dbo].[SSRS_HISTORY]([REPORT_DATE] ASC, [SERVER_NAME] ASC, [DATABASE_NAME] ASC, [INSTANCE_NAME] ASC);
...
GO
ALTER TABLE [dbo].[DATABASES_2_COLLECT]
    ADD DEFAULT -1 FOR [NUM_PLANS_TO_KEEP];
...
GO
ALTER TABLE [dbo].[DATABASES_2_COLLECT]
    ADD DEFAULT 0 FOR [IGNORE_QUERIES_UNDER_MS];
...
GO
ALTER TABLE [dbo].[DATABASES_2_COLLECT]
    ADD DEFAULT 100 FOR [COLLECT_TOP_X_QUERIES];
...
GO
ALTER TABLE [dbo].[DATABASES_2_COLLECT]
    ADD DEFAULT 30 FOR [COLLECT_TOP_X_PLANS];
...
GO
ALTER TABLE [dbo].[DATABASES_2_COLLECT]
    ADD DEFAULT 100 FOR [KEEP_TOP_X_QUERIES_BY_MONTH];
...
GO
ALTER TABLE [dbo].[DATABASES_2_COLLECT]
    ADD DEFAULT 100 FOR [KEEP_TOP_X_PLANS_BY_MONTH];
...
GO
ALTER TABLE [dbo].[DATABASES_2_COLLECT]
    ADD DEFAULT 60 FOR [PURGE_PLANS_AFTER_X_DAYS];
...
GO
PRINT N'Creating unnamed constraint on [dbo].[SSRS_CONFIG]...';
...
GO
ALTER TABLE [dbo].[SSRS_CONFIG]
    ADD DEFAULT 7 FOR [RETAIN_DETAILS_DAYS];
...
CREATE PROCEDURE DYNPERF_COLLECT_SSRS_EXECUTIONLOG (
											  @DEBUG         NVARCHAR(1))
AS
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = 'c85084ec-999b-4d3a-9667-2686829ac372')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('c85084ec-999b-4d3a-9667-2686829ac372')
...
VALUES('2.00 RTM 20170315', GETDATE(), '')

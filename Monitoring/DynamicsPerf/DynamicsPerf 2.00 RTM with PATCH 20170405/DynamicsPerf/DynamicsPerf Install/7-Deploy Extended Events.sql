...
ADD EVENT sqlserver.lock_escalation(
    ACTION(package0.collect_system_time,sqlserver.client_hostname,sqlserver.context_info)) 
ADD TARGET package0.event_file(SET filename=N'C:\SQLTrace\DYNAMICS_BLOCKING.xel',max_file_size=(50),max_rollover_files=(10))
...
ADD TARGET package0.event_file(SET filename=N'C:\SQLTrace\DYNAMICS_LONG_DURATION.xel',max_file_size=(50),max_rollover_files=(10))
...
ADD EVENT sqlserver.full_text_crawl_stopped(SET collect_database_name=(1)
    ACTION(package0.collect_system_time,sqlserver.database_name)) 
ADD TARGET package0.event_file(SET filename=N'C:\SQLTrace\DYNPERF_MISC.xel',max_file_size=(10),max_rollover_files=(10))
--,ADD TARGET package0.ring_buffer(SET max_memory=(131072))
